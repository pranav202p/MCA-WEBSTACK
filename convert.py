...
# Load XML
xml_tree = etree.parse("C:\webstack\lab 5\emp.xml")

# Load XSL
xsl_transform = etree.XSLT(etree.parse("C:\webstack\lab 5\emp.xsl"))

# Apply XSLT transformation
html_tree = xsl_transform(xml_tree)

# Validate against XSD
xmlschema = etree.XMLSchema(etree.parse("C:\webstack\lab 5\schema.xsd"))
